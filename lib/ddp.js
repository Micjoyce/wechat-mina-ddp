...
const PUBLIC_EVENTS = [
    ...
    "ready", "nosub", "added", "changed", "removed", "streamer",
    // Method messages
    "result", "updated",
    // Error messages
    "error"
    ...
    constructor (options) {
        ...
        this.socket.on("message:in", message => {
            if (message.msg === "connected") {
              ...
              if (message && message.msg === 'changed' && message.collection && message.fields && message.fields.eventName && message.fields.args) {
                this.emit("streamer", message)
              } else {
